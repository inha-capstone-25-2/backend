...
CATEGORY_SEED: List[Dict] = [
    ...
    },
    {
        ...
        "depth": 1,
        "names": {
            "en": "Electrical Engineering and Systems Science",
            "ko": "전기공학·시스템 과학",
        },
    },
    {
    ...
    },
    {
        ...
        "depth": 3,
        "names": {
            "en": "Cosmology and Extragalactic Astrophysics",
            "ko": "우주론·외은하 천체물리",
        },
    },
    {
    ...
    },
    {
        ...
        "depth": 3,
        "names": {
            "en": "Instrumentation and Methods",
            "ko": "관측 장비·천문 관측 기법",
        },
    },
    {
    ...
    },
    {
        ...
        "depth": 2,
        "names": {
            "en": "High Energy Physics - Lattice",
            "ko": "고에너지 물리 격자 계산",
        },
    },
    {
        ...
        "depth": 2,
        "names": {
            "en": "High Energy Physics - Phenomenology",
            "ko": "고에너지 물리 현상론",
        },
    },
    {
    ...
    },
    {
        ...
        "depth": 2,
        "names": {
            "en": "Atmospheric and Oceanic Sciences (legacy)",
            "ko": "대기·해양 과학 (구 분류)",
        },
    },
    # ---------------- Computer Science (cs) ----------------
    ...
    },
    {
        ...
        "depth": 2,
        "names": {
            "en": "Computer Science and Game Theory",
            "ko": "알고리즘·게임이론(컴퓨터 과학 관점)",
        },
    },
    {
        "code": "cs.HC",
    ...
    },
    {
        ...
        "depth": 2,
        "names": {
            "en": "Computational Linguistics (legacy)",
            "ko": "계산 언어학 (구 분류)",
        },
    },
    #
...
def seed_categories(db: Session) -> None:
    ...
    def _get_or_create_category(item: Dict) -> Category:
        ...
        if parent_code:
            ...
            if not parent_obj:
                raise ValueError(
                    f"Parent category '{parent_code}' for '{code}' not found"
                )
...
def _create_category_from_seed(
    db: Session, item: Dict, existing_by_code: Dict[str, Category]
):
    code = item["code"]
    parent_obj = None
    parent_code = item.get("parent")
