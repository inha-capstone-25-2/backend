...
public class PaperService {
    ...
    public PaperSearchResponse searchPapers(Long userId, String query, List<String> categories, int page, String sortBy) {
        int pageSize = 10;
    ...
    public PaperDetailResponse getPaperDetail(Long userId, String paperId) {
