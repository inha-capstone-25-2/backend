...
class TestPaperService:
    ...
    def test_search_papers_with_logging(
        self, mock_log_activity, mock_repo_class, mock_mongo_db, sample_user
    ):
    ...
    def test_get_paper_detail(
        self, mock_repo_class, mock_mongo_db, sample_user, sample_paper_doc
    ):
